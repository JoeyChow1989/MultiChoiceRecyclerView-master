...
public class SampleCustomActivity extends BaseActivity {
    ...
    private void setUpMultiChoiceRecyclerView() {
        ...
        getSampleMessageList()
                ...
                .subscribe(new Subscriber<List<com.davidecirillo.multichoicesample.SampleCustomView.MessageV0>>() {
                    @Override
                    ...
                    public void onNext(List<MessageV0> messageV0s) {
                        ...
                        com.davidecirillo.multichoicesample.SampleCustomView.SampleCustomViewAdapter adapter = new SampleCustomViewAdapter(new ArrayList<>(messageV0s), SampleCustomActivity.this);
